...
def process_image(image_path, clf, window_size=(128, 128), step_size=16, show_images=True, nms_threshold=0.5, classifier_size=32, proba_threshold=0.99, output_path=None):
    '''
